...
public class AccountRepositoryimpl implements AccountRepository {
    ...
    @Override
    @Transactional
    public void updateUserAndCheck(Long user_id, Long account_id) {
        try {
    ...
    @Override
    @Transactional(readOnly = true)
    public Account getCheckByIdAndUserEmail(Long account_id, String email) {
        try {
    ...
    @Override
    @Transactional
    public boolean updateEnableByIdAndUserEmail(Long account_id, String email, boolean bol) {
    ...
    @Override
    @Transactional
    public void changeSumById(Long account_id, BigDecimal sum) {
